...
function _omb_theme_PROMPT_COMMAND {
  ...
  # User and host
  local user_host_prefix=" $_omb_prompt_blue["
  local user_host_suffix="$_omb_prompt_blue]"
  local user="$_omb_prompt_yellow\u"
  local host="$_omb_prompt_cyan\H"
  local at="$_omb_prompt_green@"
  PS1+="$user_host_prefix$user$at$host$user_host_suffix"

  # Working directory
  PS1+="$_omb_prompt_yellow in $_omb_prompt_red\W$_omb_prompt_reset_color"

  # SCM
  PS1+=" $(scm_prompt_char_info)"

  # End prompt 󰜴
  # PS1+="\n${_omb_prompt_yellow}❯${_omb_prompt_green}❯${_omb_prompt_cyan}❯${_omb_prompt_red}❯ $_omb_prompt_normal"
  # PS1+="\n${_omb_prompt_yellow}➜${_omb_prompt_green}➜${_omb_prompt_cyan}➜${_omb_prompt_red}➜ $_omb_prompt_normal"
  PS1+="\n${_omb_prompt_red}󱞩 $_omb_prompt_normal"
}
